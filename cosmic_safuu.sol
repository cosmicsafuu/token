/**
 * Cosmic Safuu Protocol = Cosmic auto compouding protocol  Dual Reward with BUSD Dividend
 * CSF Token
 * Dual Reward with Auto-Staking, Auto-Compounding & BUSD Reflection
 *
 * Website : https://cosmicsafuu.finance
 * Whitepaper : https://cosmicsafuu.gitbook.io/docs
 * Twitter : twitter.com/cosmicsafuu
 * Telegram : t.me/cosmicsafuu
 */
...
contract Cosmic_safuu is ERC20Detailed, Ownable {
    ...
    uint256 public constant FIRST_REBASE_RATE = 2368;
    ...
    constructor() ERC20Detailed("CosmicSAFUU", "CSF", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xc568C30f9a11fDC7847EAa9e98F03F7E83a2F786;
        treasuryReceiver = 0x9A0a65eec5F7619A27Df12C263db28FAB517d654;   
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no CSF token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
